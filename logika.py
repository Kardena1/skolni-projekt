...
def vypocitat_a(data,energie,vaha,poc_teplot):
    ...
    energie,vaha,poc_teplot,bod_tani,bod_varu,tep_kap_pev,tep_kap_kapal,skup_tani,skup_varu = float(energie),float(vaha),int(poc_teplot),int(bod_tani),int(bod_varu),int(tep_kap_pev),int(tep_kap_kapal),int(skup_tani),int(skup_varu)
